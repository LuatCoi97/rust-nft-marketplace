use ::{
    ...
    mpl_token_metadata::{ ID as TOKEN_METADATA_ID, instruction as token_instruction },
};

declare_id!("H4KMJ48ABXARu6EsoHENoFdeQCYfsjqmsqmCjgEdy4pQ");
...
pub mod mint_nft {
    ...
    pub fn mint(
        ctx: Context<MintNft>,
        metadate_title: String,
        metadate_symbol: String,
        metadate_uri: String
    ) -> Result<()> {
